  ...
  return (
    <>
      {enableSpotlight && (
        <GlobalSpotlight
          gridRef={gridRef}
          disableAnimations={shouldDisableAnimations || focusedCard !== null}
        ...
        {cardData.map((card, index) => {
          ...
          const cardProps = {
            ...
            style: {
              ...
              "--textfont": card.textfont || "sans-serif",
          ...
          if (enableStars) {
            return (
              <ParticleCard
                key={index}
                {...cardProps}
                disableAnimations={shouldDisableAnimations || isFocused}
                particleCount={particleCount}
                glowColor={glowColor}
                enableTilt={enableTilt && !isFocused}
                clickEffect={clickEffect && !isFocused}
                enableMagnetism={enableMagnetism && !isFocused}
                onClick={handleClick}
              >
                <div
